package com.wy.transfer.servlet;

import com.wy.transfer.response.MyResponse;
import com.wy.transfer.service.TransferService;
import com.wy.transfer.service.impl.TransferServiceImpl;
import com.wy.transfer.utils.JsonUtils;
 ...
 * 非常多，这种情况下，影响面很大，不利于系统的扩展性、维护性和稳定性。并且违背了迪米特法则。
